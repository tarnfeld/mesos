...
#ifndef __DOCKER_ISOLATOR_HPP__
#define __DOCKER_ISOLATOR_HPP__
...
class DockerIsolator : public Isolator
{
public:
  DockerIsolator();
...
private:
  ...
  DockerIsolator(const DockerIsolator&);
  DockerIsolator& operator = (const DockerIsolator&);
